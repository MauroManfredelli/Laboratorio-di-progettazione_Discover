		    	...
		    	<div style="padding-left: 20px;">
			    	<h3 class="m-0">
			        	...
			        	<span class="pull-right" style="padding-right: 20px;">
			        		<a class="fa fa-info-circle text-primary" data-toggle="tooltip" title="Dettagli attrazione" style="cursor: pointer;" href="/discover/attrazione/${attrazione.id}" target="_blank"></a>
			        	</span>
			        	<br>
			        	<c:choose>
					...
					<div class="col-md-6" style="padding-top: 20px;">
						...
						<div class="row" style="padding-top: 15px;">
							<div class="col-md-12" style="text-align: right; font-size: 30px;">
								<c:if test="${attrazione.stato.id == '1' or attrazione.stato.id == '2'}">
