...
<div class="col-md-3 col-md-offset-9" style="width: auto; position: fixed; top: 105px; z-index: 1; right: 0px;  background-color: #FFF; padding-top: 10px; padding-bottom: 10px; border: 1px solid #3c8dbc; border-right: none; border-top-left-radius: 20px; border-bottom-left-radius: 20px;" id="inputSelectLista">
	...
	<span id="scegliLista" class="hidden">
		<label>Lista selezionata:&nbsp;&nbsp;<i class="fa fa-plus-circle text-primary" onclick="creaWishlist()" data-toggle="tooltip" data-placement="bottom" title="Crea wishlist" style="cursor: pointer;"></i> <i class="fa fa-times-circle text-danger" onclick="mostraScegliLista()" data-toggle="tooltip" data-placement="bottom" title="Chiudi" style="cursor: pointer;"></i></label>
