...
<div class="col-md-3 col-md-offset-9" style="width: auto; position: fixed; top: 105px; z-index: 999999; right: 5px;  background-color: #FFF; padding-top: 10px; padding-bottom: 10px; border: 1px solid #3c8dbc;" id="inputSelectLista">
	<i class="fa fa-suitcase text-info hidden" onclick="mostraScegliLista()" id="btnMostraScegliLista" style="cursor: pointer;"></i>
	<span id="scegliLista">
